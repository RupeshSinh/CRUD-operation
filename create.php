...
<body bgcolor='#f0f0f0' text='#f45673'>
    ...
    <tr>
        ...
        <td><input type="text" name="id" placeholder="Developer id" required></td>
    </tr>
    <tr>
        <td>Enter Your First name
        <td><input type="text" name="f" placeholder="First name" required></td>
    </tr>
    <tr>
        <td>Enter Your Last name
        <td><input type="text" name="l" placeholder="Last name" required></td>
    </tr>
    <tr>
        <td>Enter Your Email Id
        <td><input type="text" name="e" placeholder="Email" required></td>
    </tr>
    <tr>
        <td>Enter Your Phone no.
        <td><input type="text" maxlength="10" name="m" placeholder="Mobile number" required></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="file" name="p">(size:200kb)</td>
    </tr>
    <tr>
